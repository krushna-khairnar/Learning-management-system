...
const Hero = () => {
  return (
    <div className="flex flex-col items-center justify-center w-full md:pt-36 pt-20 px-7 md:px-0 space-y-7 text-center bg-gradient-to-b from-cyan-100/70">
      ...
      <h1 className="relative font-bold text-gray-800 max-w-3xl mx-auto 
                     text-home-heading-small md:text-[2.75rem] md:leading-[1.2]">
        Empower Your Future with Our{' '}
        <span className="text-blue-600 md:text-[2.9rem] md:leading-[1.15]">
          Expert-Led Courses!
        </span>
        <img 
          src={assets.sketch} 
